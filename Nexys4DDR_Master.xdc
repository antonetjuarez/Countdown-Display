...
## ## ## READ ME: ## ## ##
## ## ## ## ## ##  ## ## ##
## Since I ask you to use the name that match with the name used here, you will NOT change the signal name in here. Only need to uncomment the pins that you want to use in your top-level code


## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK100MHZ }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz

## no need to uncomment the line below
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {CLK100MHZ}];

## Uncomment the swtiches that you want to use
##Switches
...
## Uncomment LEDs that you want to use
## LEDs
...
## Uncomment All (except DP) below if you use 7 segment display 
##7 segment display
...
## Uncomment below if you use Push button on the FPGA board 
##Buttons
